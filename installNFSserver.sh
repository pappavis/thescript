...
mount -t nfs -o proto=tcp,port=2049 pilamp:/nfsshare /mnt
mount -t nfs -o proto=tcp,port=2049 pi0:/nfsshare /mnt
mount -t nfs -o proto=tcp,port=2049 pivhere:/nfsshare /mnt
mount -t nfs -o proto=tcp,port=2049 retropie:/nfsshare /mnt
