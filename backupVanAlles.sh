#!/bin/bash
LOGFILE=/home/pi/logs/backupVanAlles-`date +%Y-%m-%d_%Hh%Mm`.log
...
sudo mkdir /mnt/usb0/rugsteun/oud  2>&1 | tee -a $LOGFILE
lsblk -fp  2>&1 | tee -a $LOGFILE
sudo blkid  2>&1 | tee -a $LOGFILE
sudo mount -t auto -o defaults  /dev/sda1 /mnt/usb0/  2>&1 | tee -a $LOGFILE
sudo cp -v /mnt/usb0/rugsteun/*_backup.7z /mnt/usb0/rugsteun/oud  2>&1 | tee -a $LOGFILE
...
sudo 7z a $BACKUPDIR/$(hostname)_dbs_backup.7z -r  /home/pi/dbs  2>&1 | tee -a $LOGFILE
sudo 7z a $BACKUPDIR/$(hostname)_.octoprint_backup.7z -r  /home/pi/.octoprint  2>&1 | tee -a $LOGFILE
sudo 7z a $BACKUPDIR/$(hostname)_.homeassistant_backup.7z -r  /home/pi/.homeassistant  2>&1 | tee -a $LOGFILE
sudo 7z a $BACKUPDIR/$(hostname)_.node-red_backup.7z -r  /home/pi/.node-red  2>&1 | tee -a $LOGFILE
sudo 7z a $BACKUPDIR/$(hostname)_.npm_backup.7z -r  /home/pi/.npm  2>&1 | tee -a $LOGFILE
sudo 7z a $BACKUPDIR/$(hostname)_single_chan_pkt_fwd_backup.7z -r  /home/pi/single_chan_pkt_fwd  2>&1 | tee -a $LOGFILE
sudo 7z a $BACKUPDIR/$(hostname)_.venv_backup.7z -r  /home/pi/.venv  2>&1 | tee -a $LOGFILE
sudo 7z a $BACKUPDIR/$(hostname)_.local_backup.7z -r  /home/pi/.local  2>&1 | tee -a $LOGFILE
sudo 7z a $BACKUPDIR/$(hostname)_Programmering_backup.7z -r  /home/pi/Programmering  2>&1 | tee -a $LOGFILE
sudo 7z a $BACKUPDIR/$(hostname)_micropython_backup.7z -r  /home/pi/.micropython  2>&1 | tee -a $LOGFILE
