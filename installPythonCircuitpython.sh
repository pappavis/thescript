#/usr/bin/sh
echo "Installeer nieuwe python3 virtuale omgeving" source ~/venv/venv3.7 
pip3 install adafruit-blinka adafruit-circuitpython-ble-adafruit adafruit-circuitpython-ina219 adafruit-circuitpython-tinylora adafruit-circuitpython-ssd1306 
...
pip3 install Adafruit_Libraries Adafruit-PCA9685 Adafruit-GPIO  raspiSensors  oled-text  pi-ina219
pip3 install OctoPyClient tentacle ledDriver
