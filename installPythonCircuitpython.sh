...
pip3 install rpi.gpio adafruit-blinka adafruit-circuitpython-ble-adafruit adafruit-circuitpython-ina219 adafruit-circuitpython-tinylora adafruit-circuitpython-ssd1306  DotStar_Emulator
