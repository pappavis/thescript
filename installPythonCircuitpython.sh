...
pip install --upgrade Adafruit_Libraries Adafruit-PCA9685 Adafruit-GPIO  raspiSensors  oled-text  pi-ina219
pip install --upgrade OctoPyClient tentacle ledDriver
pip install --upgrade ampy micropython-uploader
pip  install --upgrade  Adafruit-GPIO SQLAlchemy adafruit-ads1x15 adafruit-pureio aniso8601 croniter flask-restful flask-sqlalchemy natsort pih2o python-dateutil pytz
