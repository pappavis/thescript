...
for addonnodes in adafruit-blinka wiringpi adafruit-python-shell  adafruit-micropython-blinka adafruit-circuitpython-ble-adafruit adafruit-circuitpython-neopixel adafruit-circuitpython-ina219 adafruit-circuitpython-tinylora adafruit-circuitpython-ssd1306  DotStar_Emulator \
