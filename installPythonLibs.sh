...
for addonnodes in pip setuptools wheel openpyxl py7zr o365 ttn qrcode pillow sqlalchemy pymsteams esptool adafruit-ampy firebirdsql esptool mu-editor shortcut \
		   ...
		   osxphotos RPi.GPIO tox tflite tflite-runtime tflite_support  ; do
