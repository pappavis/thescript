...
for addonnodes in pip setuptools wheel openpyxl pylzma py7zr o365 ttn qrcode pillow sqlalchemy sqlalchemy-access pymsteams qscintilla esptool adafruit-ampy firebirdsql pyresidfp  \
		   ...
		   tk-tools pyqt5 aspose-words Office365-REST-Python-Client  pyresidfp googlemaps discotool  \
     		   soundcard pandas streamlit PyPDF2 g4f g4f[webview] langgraph langchain-openai langchain duckduckgo-search langchain-community langchain-experimental tavily-python
