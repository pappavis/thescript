...
for addonnodes in homebridge-octoprint@latest  homebridge-camera-ffmpeg  homebridge-ftp-motion  @jappyjan/homebridge-wled  homebridge-neopixel  homebridge-domoticz-selector-switch homebridge-tasmota  @credding/homebridge-sonos  homebridge-smarthome  homebridge-apple-tv homebridge-nest-google homebridge-camera-ui  @oscar_penelo/homebridge-camera-ffmpeg-2way  homebridge-doorbell-telegram-photo  homebridge-website-to-camera  homebridge-mqttthing  homebridge-rpi homebridge-p1  homekit-code  homebridge-ring  @homebridge/bluetooth-hci-socket homebridge-ikea-tradfri-gateway  homebridge-weather  homebridge-bravia  homebridge-samsungtv-control  homebridge-calendar  homebridge-ewelink  homebridge-z2m  homebridge-pihole  homebridge-bravia-tvos homebridge-androidtv  homebridge-samsung-tizen   homebridge-webos-tv  homebridge-homewizard  homebridge-brewer  homebridge-music  @hoobs/ikea-tradfri  homebridge-alexa  homebridge-website-to-camera  homebridge-xbox-one  homebridge-kodi    homebridge-playstation  homebridge-noip  homebridge-gpio  homebridge-icloud  homebridge-bmp180   homebridge-openhab2-complete   homebridge-tesla-powerwall  homebridge-lighthouse  homebridge-mqtt-television    ; do 
	echo ""  2>&1 | tee -a $LOGFILE
	echo ""  2>&1 | tee -a $LOGFILE
